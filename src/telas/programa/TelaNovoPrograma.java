...
public class TelaNovoPrograma extends TelaPadrao {
	...
	public void adiconarLabels() {
		...
		apresentadores = Componentes.addJLabel(this, "Apresentadores", 190, 390, Medidas.COMPRIMENTO_255, Medidas.ALTURA_30);
	...
	private void adicionandoComboBox() {
		...
		status = Componentes.inserirComboBox(this, statusTxt, 330,190, 
		...
		generos = Componentes.inserirComboBox(this,generosTxt,
				400, 415, 150, Medidas.ALTURA_30);
		
		ArrayList<String> estilosTxt = central.obterEstilosDePrograma();
		estilos = Componentes.inserirComboBox(this, estilosTxt, 190, 415,
