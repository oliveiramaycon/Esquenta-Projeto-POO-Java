...
public class RealityShows extends ProgramasContinuos {
	...
	public RealityShows(String nome, ArrayList<DayOfWeek> dia, Canal canal, String horario, Status status, String temporadas) {
		super(nome, canal, dia, horario, status, temporadas);
